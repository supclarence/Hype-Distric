...
<header>
    ...
    <div class="product-grid">
        <div class="product">
            ...
            <p><strong>Name:</strong> Shadow Crest Cap</p>
        ...
        <div class="product">
            ...
            <p><strong>Name:</strong> Beanie Skully</p>
        ...
        <div class="product">
            ...
            <p><strong>Name:</strong> Luna Minimalist Ring</p>
        ...
        <div class="product">
            ...
            <p><strong>Name:</strong> Aurora Twisted Band</p>
            <p><strong>Price:</strong> 400</p>
            <p><strong>Color:</strong> Silver</p>
            <p><strong>Material:</strong> Silver</p>
